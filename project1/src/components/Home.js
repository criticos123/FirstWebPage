...
const mainFeaturedPost = {
  ...
  description:"Our Company holds on to many properties that are available to Rent. Feel free to contact us with any questions or if you want to book a tour for one our units",
          ...
          <Grid container spacing={4}>
            {cards.map((post) => (
                  ...
                  <CardActions>
                      ...
                      <Link className={classes.link} to={`/${post.buttonLink}`}>
                        {post.buttonLink}
                      </Link>
                      </Button>
                    </CardActions>
