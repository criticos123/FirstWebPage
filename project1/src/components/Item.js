...
export default function MediaControlCard() {
  ...
  const {id}=useParams();
   ...
   const { imageFront,imageKitchen,imageBedroom,imageBathroom, imageLivingroom, price, apartmentName, streetAddress } = rentalItem
    ...
    <Card>
      ...
      <div className={classes.imgcontainer}>
          ...
          <div className={classes.overlay}>
            <img className={classes.frontdoor} src={imageFront} alt="FrontDoor"/>
